...
//    $price  = number_format($price); 
    ...
    $result = $items->add($categoryId, $title, $title, $description, $imgUrl, $imgUrl, $allowComments, $price, $postArea, $postCountry, $postCity, $postZipcode, $postLat, $postLng, $model, $year, $note);
    ...
    if (strlen($imgUrl2) != 0) {
        ...
        $images->add($result['itemId'], $imgUrl2, $imgUrl2, $imgUrl2);
    }

    if (strlen($imgUrl3) != 0) {

        $images->add($result['itemId'], $imgUrl3, $imgUrl3, $imgUrl3);
    }

    if (strlen($imgUrl4) != 0) {

        $images->add($result['itemId'], $imgUrl4, $imgUrl4, $imgUrl4);
    }
